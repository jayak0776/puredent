    ...
    <div className="bg-primary text-secondary dark:bg-dark_primary dark:text-dark_secondary w-full h-full p-10 md:p-16 lg:p-20">
      <div className="text-center">
        ...
        <p className="text-xl py-3 md:text-2xl">
          ...
          technology at our office in San Francisco.
        </p>
      ...
      <div className="md:flex md:p-10 md:gap-10 lg:justify-center lg:gap-20">
        <div className="text-center py-6 md:py-0">
          <h1 className="text-2xl md:text-3xl font-extrabold lg:text-4xl uppercase">
            San Francisco
          </h1>
          <h3 className="text-lg">hello@zendentalsf.com</h3>
          <h4 className="text-lg">415-857-0150</h4>
          <br />
          ...
          {!formSubmitted ? (
            <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
              ...
              <input
                ...
                className="rounded-sm text-primary dark:text-dark_primary bg-secondary dark:bg-dark_secondary p-2 focus:outline-none"
              />
              ...
              <button
                type="submit"
                className="bg-secondary text-primary dark:text-dark_primary p-3 rounded-md font-semibold mt-4 hover:bg-shade hover:text-primary duration-300"
              >
                Submit
              </button>
            </form>

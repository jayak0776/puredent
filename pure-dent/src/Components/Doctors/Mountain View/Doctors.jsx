...
import { mountainViewDoctors } from "../../DentalFeatures";
...
function Doctors() {
  ...
  return (
    <div className="lg:p-20 md:p-16 p-8 bg-secondary text-primary dark:text-dark_primary w-full h-full">
      <h1 className="text-center md:text-5xl lg:text-7xl text-3xl font-extrabold mb-1 md:mb-4 lg:mb-8 uppercase">
        Our Dental Experts
      </h1>

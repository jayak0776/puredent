  ...
  return (
    <div className="text-primary dark:text-dark_primary bg-secondary p-3 m-2 rounded-sm md:p-6 md:m-3 lg:p-8 lg:m-4 lg:w-[30%] lg:relative lg:left-[34%] shadow-2xl">
      ...
      <ul className="list-disc px-4 md:text-xl lg:text-2xl">
        ...
        <li>Three cleanings per year</li>
        <li>25% off any additional Cleanings</li>
        <li>Intra-oral X-rays (1/yr) and emergency exams</li>
        <li>20% off all non-cosmetic treatments</li>
        <li>$400 off Invisalign</li>
        <li>10% off all veneers treatments</li>
      </ul>
      <div className="p-3 md:p-6">
        {login ? (
          <button className="py-2 px-4 bg-primary dark:hover:bg-dark_shade dark:hover:text-dark_primary dark:bg-dark_primary text-secondary duration-300 rounded-sm font-extrabold md:py-3 md:px-6 md:text-lg hover:bg-shade hover:text-primary shadow-lg shadow-shade">

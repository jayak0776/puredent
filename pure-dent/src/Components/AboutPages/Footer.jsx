...
function Footer() {
  ...
  return (
    <div className="text-secondary w-full h-full bg-primary dark:bg-dark_primary">
      <h1 className="text-center text-4xl md:text-5xl px-10 py-6 pb-0 md:pt-10 lg:pt-10 lg:text-7xl lg:px-32 lg:py-12 lg:pb-0 font-extrabold">
        PURE DENT
      </h1>
      <div className="flex flex-col lg:flex-row items-center justify-evenly">
        <div className="px-6 py-8 lg:px-32 lg:py-16">
          <h1 className="text-xl pb-1 md:text-2xl uppercase lg:text-3xl text-center font-semibold lg:pb-2">
      ...
      <hr className="w-[70%] mx-auto border-1 border-secondary" />
